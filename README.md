...
4. **Model Lineage Downgrade:** Thinking tokens generated by frontier models (e.g. Claude Opus 5.5, Claude 3.7 Sonnet, OpenAI o3) can be injected into weaker sibling models (e.g. Claude Haiku, 4o-mini), coercing refusal overrides.
