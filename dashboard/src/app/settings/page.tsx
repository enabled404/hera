    ...
    <div className="max-w-5xl space-y-8 animate-enter-down">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/[0.08] pb-6">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-slate-500 font-mono">Zero-Trust Config</span>
          </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            <RefreshCw className={`h-3.5 w-3.5 text-cyan-400 ${keyRotated ? "animate-spin" : ""}`} />
      ...
      <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div
              ...
              className={`p-4 rounded-xl border cursor-pointer transition-all ${
                mode === "STATEFUL_VAULT"
                  ? "bg-zinc-850 border-cyan-400/80 shadow-[0_0_20px_rgba(6,182,212,0.2)]"
                  : "bg-zinc-950/40 border-white/[0.06] hover:border-white/[0.14] hover:bg-zinc-900/30 text-slate-400"
              }`}
            >
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono text-slate-400 bg-zinc-800/60 border border-white/[0.08] px-2 py-0.5 rounded">
                  Autonomous
                </span>
              </div>
              <p className="text-xs text-slate-400 mt-2 font-sans leading-relaxed">
              ...
              <div className="mt-3 text-[10px] font-mono text-slate-500 flex items-center space-x-1">
            ...
            {mode === "STATEFUL_VAULT" ? (
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="bg-black/60 border border-white/[0.1] rounded-lg px-3 py-1.5 text-xs font-mono text-white w-32 focus:outline-none focus:border-cyan-400"
                />
                <span className="text-xs font-mono text-slate-400">seconds (1h)</span>
              </div>
            ) : (
              <select
                value={cipherSuite}
                onChange={(e) => setCipherSuite(e.target.value)}
                className="bg-black/60 border border-white/[0.1] rounded-lg px-3 py-1.5 text-xs font-mono text-white w-56 focus:outline-none focus:border-cyan-400"
              >
            ...
            <div className="flex items-center justify-between p-3.5 rounded-xl bg-black/40 border border-white/[0.06]">
              <div className="space-y-0.5">
                <div className="text-xs font-medium text-white flex items-center space-x-2">
                  ...
                  <span className="text-[10px] font-mono text-cyan-400 bg-cyan-950/40 border border-cyan-500/30 px-1.5 py-0.2 rounded">
                    MANDATORY
                  </span>
                </div>
            ...
            <div className="flex items-center justify-between p-3.5 rounded-xl bg-black/40 border border-white/[0.06]">
              <div className="space-y-0.5">
                <div className="text-xs font-medium text-white flex items-center space-x-2">
                  ...
                  <span className="text-[10px] font-mono text-indigo-400 bg-indigo-950/40 border border-indigo-500/30 px-1.5 py-0.2 rounded">
                    v1.1 Core
                  </span>
                </div>
                <div className="text-[11px] text-slate-400">
        ...
        <div className="flex items-center justify-between pt-2">
          <button
            type="submit"
            className="px-6 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black font-sans font-medium text-xs shadow-[0_0_20px_rgba(6,182,212,0.35)] transition duration-200"
          >
